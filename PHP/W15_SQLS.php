<?php
$sqls = [
"UPDATE students SET name='鐘冠武', address='1310534034' WHERE sno='S002'",
...
"SELECT * FROM students WHERE sno='S002'",
"SELECT * FROM students WHERE address LIKE '%034%'",
"SELECT * FROM students WHERE birthday LIKE '1__6%'",
"SELECT * FROM courses WHERE credits=3",
"SELECT * FROM students WHERE birthday='1996-01-02'",
"SELECT * FROM students WHERE sno<='S003' AND name LIKE '%鐘%'",
"SELECT * FROM Students WHERE sno<'S003' OR name LIKE '%張%'",
"SELECT * FROM students WHERE sno>='S002' AND sno<='S004' OR name LIKE '%陳%'",
"SELECT * FROM students WHERE (name LIKE '%鐘%' OR address LIKE '新北巿' ) AND sno<='S002'",
"SELECT * FROM courses WHERE credits>2 ORDER BY credits ASC",
"SELECT * FROM courses WHERE credits>2 ORDER BY credits DESC",
"SELECT * FROM students WHERE birthday BETWEEN '1996-01-01' AND '1996-12-31'",
"SELECT * FROM students WHERE sno IN ('S001', 'S002', 'S004')",
